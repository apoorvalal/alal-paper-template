...
\title{Paper Title : Subtitle \thanks{Acknowledgements here. ~\textbf{Current version}: July 30, 2018;
\textbf{Corresponding author}:
\href{mailto:apoorval@stanford.edu}{\nolinkurl{apoorval@stanford.edu}}.}  }



\author{\Large Apoorva Lal\vspace{0.05in} \newline\normalsize\emph{Stanford}   \and \Large Karen Seto\vspace{0.05in} \newline\normalsize\emph{Yale}  }
...
% \titleformat{\section}[block]{\Large\scseries\filcenter}{}{1em}{}
...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Apoorva Lal (Stanford) and Karen Seto (Yale)},
...
mathtools, enumitem, fancyhdr, booktabs}
...

{
  ...
  \textbf{Apoorva Lal} \hskip 15pt \emph{\small Stanford}   \par \textbf{Karen Seto} \hskip 15pt \emph{\small Yale}   
}
}
